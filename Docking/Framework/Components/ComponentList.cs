...
namespace Docking.Components
{
   ...
   public partial class ComponentList : Gtk.Bin, IComponent, IComponentInteract, ILocalizable
   {
      ...
      string ILocalizable.Name { get { return "Component List"; } }
      ...
      public ComponentList()
      {
         ...
         Gtk.TreeViewColumn componentColumn = new TreeViewColumnLocalized() { Title = "Component", Resizable = true, Sizing = Gtk.TreeViewColumnSizing.Fixed, FixedWidth = 200 };
         Gtk.TreeViewColumn instanceCountColumn = new TreeViewColumnLocalized() { Title = "Instances", Resizable = true, Sizing = Gtk.TreeViewColumnSizing.Fixed, FixedWidth = 50 };
         Gtk.TreeViewColumn descriptionColumn = new TreeViewColumnLocalized() { Title = "Description", Resizable = true, Sizing = Gtk.TreeViewColumnSizing.Fixed, FixedWidth = 300 };
