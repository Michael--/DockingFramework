...
namespace Docking.Components
{
	public class ComponentFinder
	{
		...
		{
			public ComponentFactoryInformation (String filename, Type[] types, ComponentFactory factory, bool active)
			{
				Debug.Assert (factory != null);
				Filename = filename;
				Types = types;
				ComponentFactory = factory;
				Typename = factory.ToString ();
				Active = active;
			}
		...
		Widget CreateInstance (ComponentFactoryInformation info, DockFrame frame)
		{
			...
			// announce types
			if (widget != null) {
				ITypes typeInterface = widget as ITypes;
